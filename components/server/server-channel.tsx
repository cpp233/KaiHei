      ...
      {channel.name !== '默认频道' && role !== MemberRole.GUEST && (
        <div className='ml-auto flex items-center gap-x-2'>
          <ActionToolTip label='编辑'>
            <Edit className='hidden group-hover:block w-4 h-4 text-zinc-500 dark:text-zinc-400 dark:hover:text-zinc-300 transition'></Edit>
          </ActionToolTip>
          <ActionToolTip label='删除'>
            <Trash className='hidden group-hover:block w-4 h-4 text-zinc-500 dark:text-zinc-400 dark:hover:text-zinc-300 transition'></Trash>
          </ActionToolTip>
        </div>
      )}
    </button>
